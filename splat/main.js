...
let defaultViewMatrix = [
    -0.587, -0.272, 0.761, 0.0, -0.808, 0.147, -0.564, 0.0, 0.047, -0.953,
    -0.31, 0.0, 5.415, 2.036, 2.485, 1.0,
];
...
async function main() {
    ...
    const url = new URL(
        ...
        // location.href,
        params.get("url") ||
            "https://huggingface.co/datasets/onandon/EmbodiedSplat/resolve/main/guitar.ply",
    ...
    const viewMatrixDisplay = document.getElementById("viewmatrix");

    const formatViewMatrix = (matrix) =>
        matrix
    ...
    const frame = (now) => {
        ...
        viewMatrixDisplay.innerText = "viewMatrix\n" + formatViewMatrix(viewMatrix);
        lastFrame = now;
