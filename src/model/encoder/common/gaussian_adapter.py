...
from .gaussians import build_covariance, matrix_to_quaternion, quaternion_to_matrix, quaternion_multiply, quaternion_normalize
...
class GaussianAdapter(nn.Module):
    ...
    def __init__(self, cfg: GaussianAdapterCfg):
        ...
        # print('cfg.sh_degree:', cfg.sh_degree)
    ...
    def forward(
        ...
        if not fusion:
            ...
            rotations = matrix_to_quaternion(c2w_rotations @ rotations_mat)
        ...
        # if ours and coords is None:
        if coords is None and not ada:
            # print('USING OURS!!!!!!!!!!!!!')
