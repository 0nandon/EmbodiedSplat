...
@dataclass
class BackboneEfficientUNetCfg:
    name: Literal["efficientunet"]
...
class BackboneEfficientUNet(Backbone[BackboneEfficientUNetCfg]):
    def __init__(self, cfg: BackboneEfficientUNetCfg, d_in: int) -> None:
        super().__init__(cfg)
        # assert d_in == 3
        self.d_in = d_in
