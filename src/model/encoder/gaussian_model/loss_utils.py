...
def l1_loss(network_output, gt):
    # print('network_ouptut.shape', network_output.shape)
    # print('gt.shape', gt.shape)

    # tensor = network_output.detach().cpu().permute(1, 2, 0)  # Now it should be [384, 512, 3]

    # # Step 2: Scale the data from range [0, 1] to [0, 255]
...
class LossLpips():
    ...
    def __init__(self, weight=0.05) -> None:
        super().__init__()
        self.weight = weight
