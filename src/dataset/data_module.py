...
class DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        dataset = get_dataset(self.dataset_cfg, "train", self.step_tracker, dense=self.dense)
    ...
    def val_dataloader(self):
        ...
        dataset = get_dataset(new_cfg, "test", self.step_tracker, dense=self.dense)
    ...
    def test_dataloader(self):
        dataset = get_dataset(self.dataset_cfg, "test", self.step_tracker, dense=self.dense, test_bev=self.test_bev,
                              colmap=self.colmap)
        dataset = self.dataset_shim(dataset, "test")
        return DataLoader(
            dataset,
