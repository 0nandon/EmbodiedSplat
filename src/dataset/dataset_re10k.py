...
class DatasetRE10kCfg(DatasetCfgCommon):
    name: Literal["re10k", "scannet", "scannetpp", "replica", "acid"]
    roots: list[Path]
    ...
    far: float = 1000.0
    phase: int = 1
    sample_num_start: int = -1
    sample_num_end: int = -1
...
class DatasetRE10k(IterableDataset):
    ...
    def __iter__(self):
        ...
        for chunk_path in self.chunks:
            ...
            for example in chunk:
                ...
                scene = example["key"]
                # print(f'stage: {self.stage}, scene: {scene}')
                ...
                try:
                    ...
                    print(f'images.shape: {len(example["images"])}, context_indices: {context_indices}')
                    exit(0)
    ...
    def convert_images(
        ...
        # print('-----------------torch_images.shape:', torch.stack(torch_images).shape)
