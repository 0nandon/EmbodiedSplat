...
For training, we cache the instance masks generated by FastSAM and the corresponding instance-level features extracted by OpenSeg. To generate these cached files, run the following command:
